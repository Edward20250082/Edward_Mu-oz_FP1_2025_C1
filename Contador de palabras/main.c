...
{
    FILE *archivo;
    char nombreArchivo[] = "C:\\Users\\munoz\\Downloads\\eBook - 23 Hábitos Anti-Procrastinación Cómo dejar de ser perezoso y tener resultados en tu vida. By S.J. Scott.txt";
    char caracter;
